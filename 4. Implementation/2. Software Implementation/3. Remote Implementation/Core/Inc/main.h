...
#define LED_CONN_PROB_Pin GPIO_PIN_15
#define LED_CONN_PROB_GPIO_Port GPIOA
#define LED_PWR_Pin GPIO_PIN_3
#define LED_PWR_GPIO_Port GPIOB
#define MPU_6050_SDA_BRIDGE_Pin GPIO_PIN_4
#define MPU_6050_SDA_BRIDGE_GPIO_Port GPIOB
