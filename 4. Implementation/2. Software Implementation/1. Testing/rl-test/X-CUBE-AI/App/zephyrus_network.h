...
#ifndef __AI_ZEPHYRUS_NETWORK_H__
#define __AI_ZEPHYRUS_NETWORK_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_ZEPHYRUS_NETWORK_MODEL_NAME          "zephyrus_network"

#define AI_ZEPHYRUS_NETWORK_ACTIVATIONS_ALIGNMENT   (4)

#define AI_ZEPHYRUS_NETWORK_IN_NUM       (1)
#define AI_ZEPHYRUS_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 4, 1, NULL), \
}
#define AI_ZEPHYRUS_NETWORK_IN_SIZE { \
  (1 * 1 * 4), \
}
#define AI_ZEPHYRUS_NETWORK_IN_1_SIZE  (1 * 1 * 4)
#define AI_ZEPHYRUS_NETWORK_IN_1_SIZE_BYTES  ((1 * 1 * 4) * 4)





#define AI_ZEPHYRUS_NETWORK_OUT_NUM      (2)
#define AI_ZEPHYRUS_NETWORK_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 2, 1, NULL), \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_ZEPHYRUS_NETWORK_OUT_SIZE { \
  (1 * 1 * 2), \
  (1 * 1 * 1), \
}
#define AI_ZEPHYRUS_NETWORK_OUT_1_SIZE  (1 * 1 * 2)
#define AI_ZEPHYRUS_NETWORK_OUT_2_SIZE  (1 * 1 * 1)
#define AI_ZEPHYRUS_NETWORK_OUT_1_SIZE_BYTES  ((1 * 1 * 2) * 4)
#define AI_ZEPHYRUS_NETWORK_OUT_2_SIZE_BYTES  ((1 * 1 * 1) * 4)

#define AI_ZEPHYRUS_NETWORK_N_NODES (4)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup zephyrus_network
 ...
 * @ref ai_zephyrus_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_zephyrus_network_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_ZEPHYRUS_NETWORK_*
 * defines into file @ref zephyrus_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_zephyrus_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_ZEPHYRUS_NETWORK_H__*/
